...
# Load models
try:
    xgb_model = joblib.load("app/models/esam_xgb.pkl")
    bilstm_model_path = os.path.join(os.path.dirname(__file__), "models", "esam_bilstm.keras")
    bilstm_model = load_model(bilstm_model_path, compile=False)
    # Consider adding Transformer model loading if you have saved models
except Exception as e:
